...
const SVG = ({iconName, fill, size}) => {
  return (
    <svg style={{height: size, width: size}} fill={fill} aria-labelledby={"simpleicons" + iconName + "-icon"} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      <title id={"simpleicons-" + iconName + "-icon"}> {iconName} </title>
